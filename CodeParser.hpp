...
public:
    ...
    std::pair<int,vector<std::pair<string,string>>> parse_argument_list(Tokenstream t, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, std::optional<std::string> class_name = {});

    std::vector<std::shared_ptr<ASTStatementNode>> parse_subspace(Tokenstream t, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, std::optional<std::string> class_name = {});

    std::shared_ptr<ASTIfElseNode> parse_if_else(Tokenstream condition, Tokenstream if_body, Tokenstream else_body, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, std::optional<std::string> class_name = {});

    std::shared_ptr<ASTWhileLoopNode> parse_while(Tokenstream condition,Tokenstream complexity_stream, Tokenstream body, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, std::optional<std::string> class_name = {});
    ...
    std::shared_ptr<ASTCallNode> parse_call(Tokenstream& t, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, int h=0, std::optional<std::string> class_name = {});

    std::shared_ptr<ASTComparisonNode> parse_comparison(Tokenstream t, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, std::optional<std::string> class_name = {});

    std::shared_ptr<ASTCalculationNode> parse_calculation(Tokenstream t, std::shared_ptr<LocalVariableManager> v, std::shared_ptr<GlobalVariableManager> g, int h = 0, std::optional<std::string> class_name = {});
    ...
    std::shared_ptr<ASTVariableNode> parse_variable(Tokenstream t, bool is_root, std::string reg, std::shared_ptr<LocalVariableManager> local_vars,
                                                    std::shared_ptr<GlobalVariableManager> global_vars, std::optional<std::string> prev_class_name= "", bool is_declaration= false,
                                                    bool comes_after_implicit_this = false);
};
